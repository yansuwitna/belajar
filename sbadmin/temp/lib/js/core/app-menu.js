(() => {
  var e,
    n = {
      2683: () => {
        !(function (e, n, a) {
          "use strict";
          var i = 0.01 * e.innerHeight;
          n.documentElement.style.setProperty("--vh", i + "px"),
            (a.app = a.app || {});
          var t = a("body"),
            o = (a(e), a('div[data-menu="menu-wrapper"]').html()),
            s = a('div[data-menu="menu-wrapper"]').attr("class");
          (a.app.menu = {
            expanded: null,
            collapsed: null,
            hidden: null,
              ...
              update: function () {
                if (!0 === a(".main-menu").data("scroll-to-active")) {
                  ...
                  if (
                    ...
                    e && (o = e.getBoundingClientRect().top + i.scrollTop),
                    o > parseInt((2 * i.clientHeight) / 3))
                  )
                    var s = o - i.scrollTop - parseInt(i.clientHeight / 2);
                  setTimeout(function () {
                    a.app.menu.container.stop().animate({ scrollTop: s }, 300),
            ...
            change: function (n) {
              ...
              ("vertical-menu" !== o && "vertical-menu-modern" !== o) ||
                this.toOverlayMenu(i.name, o),
                t.is(".horizontal-layout") &&
                  !t.hasClass(".horizontal-menu-demo") &&
                  (this.changeMenu(i.name),
                ...
                "horizontal-menu" == o &&
                  (a("li.dropdown-submenu").on("mouseenter", function () {
                    ...
                    if (n) {
                      var i = a(e).height(),
                        t = a(this).position().top,
                        o = n.offset().left,
                        s = n.width();
                      if (i - t - n.height() - 28 < 1) {
                        var l = i - t - 170;
                        a(this)
                          .find(".dropdown-menu")
                          .css({
            ...
            toOverlayMenu: function (e, n) {
              ...
              "vertical-menu-modern" == n
                ? "lg" == e || "md" == e || "sm" == e || "xs" == e
                  ? t.hasClass(a) &&
                    t.removeClass(a).addClass("vertical-overlay-menu")
                  : t.hasClass("vertical-overlay-menu") &&
                    t.removeClass("vertical-overlay-menu").addClass(a)
                : "sm" == e || "xs" == e
                ? t.hasClass(a) &&
                  t.removeClass(a).addClass("vertical-overlay-menu")
                : t.hasClass("vertical-overlay-menu") &&
            ...
            changeMenu: function (e) {
              a('div[data-menu="menu-wrapper"]').html(""),
                a('div[data-menu="menu-wrapper"]').html(o);
              ...
              "xl" === e
                ...
                : (t
                  ...
                  r.removeClass().addClass("has-sub"),
                  a.app.nav.init(),
                  a("ul.dropdown-menu [data-bs-toggle=dropdown]").on(
                    "click",
                    function (e) {
            ...
            (a.app.nav = {
                ...
                a(".navigation-main")
                  .on("mouseenter.app.menu", "li", function () {
                    ...
                    if (
                      ...
                      e.hasClass("has-sub") ||
                        ...
                        (i = e.children("a").attr("href")),
                        "" !== n &&
                          ((s = a("<a>")).attr("href", i),
                          s.attr("title", n),
                          s.text(n),
                          s.addClass("menu-title"))),
                        (o = e.css("border-top")
                  ...
                  .on("open.app.menu", "li", function (n) {
                    ...
                    i
                      ...
                      i.siblings(".open").trigger("close.app.menu"),
                      n.stopPropagation();
                  })
                  .on("close.app.menu", "li.open", function (n) {
                    var i = a(this);
                    e.collapse(i), n.stopPropagation();
                  })
                      ...
                      t.hasClass("menu-collapsed") &&
                        ...
                        setTimeout(function () {
                          if (
                            ...
                            (a(".main-menu, .navbar-header").removeClass(
                              "expanded"
                            ),
                            t.hasClass("menu-collapsed"))
                          ) {
              ...
              expand: function (e, n) {
                var i = e.children("ul"),
                  ...
                  o = a(t).outerHeight();
                e.addClass("menu-item-animating"),
                  e.css({ overflow: "hidden", height: o + "px" }),
                  e.addClass("open"),
                  a.app.nav._bindAnimationEndEvent(e, function () {
                    a.app.nav._clearItemStyle(e);
                  }),
                  setTimeout(function () {
                    e.css({ height: o + i.outerHeight() + "px" });
                  }, 50);
              },
              _bindAnimationEndEvent: function (n, i) {
                n = n[0];
                var t = function (e) {
                    e.target === n &&
                      (a.app.nav._unbindAnimationEndEvent(n), i(e));
                  },
                  o = e.getComputedStyle(n).transitionDuration;
                (o = parseFloat(o) * (-1 !== o.indexOf("ms") ? 1 : 1e3)),
                  (n._menuAnimationEndEventCb = t),
              ...
              _unbindAnimationEndEvent: function (e) {
  ...
  (i.m = n),
    ...
    (i.O = (n, a, t, o) => {
      if (!a) {
        ...
        for (m = 0; m < e.length; m++) {
          for (var [a, t, o] = e[m], l = !0, r = 0; r < a.length; r++)
            (!1 & o || s >= o) && Object.keys(i.O).every((e) => i.O[e](a[r]))
              ? a.splice(r--, 1)
              : ((l = !1), o < s && (s = o));
          if (l) {
            e.splice(m--, 1);
    ...
    i.O(
      void 0,
      [
        6663, 1713, 7363, 6621, 1267, 7532, 6938, 1257, 8280, 1758, 2908, 9115,
        4751, 3665, 6703, 7891, 321, 4840, 9716, 3629, 7007, 5469, 1574, 5025,
        8609, 9134, 5375, 5322, 7929, 810, 3830, 7428, 7305, 4911, 9476, 5074,
        7491, 2175, 790, 5097, 7564, 353, 6995, 6230, 4470, 7183, 4282, 3291,
        6629, 6362, 2762, 5199, 5162, 9396, 2995, 9722, 5569, 2550, 8209, 691,
        7512, 4758,
      ],
      () => i(2683)
    ),
