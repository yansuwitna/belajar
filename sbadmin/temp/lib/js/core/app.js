(window.colors = {
  ...
  (function (a, e, t) {
        ...
        t(".char-textarea").on("keyup", function (e) {
          ...
          (s = this),
            ...
            (function (a) {
              ...
              (s.value.length < l - 1 && (s.value = s.value.substring(0, l))),
          ...
          if (
            ...
            t.getJSON(l + "data/" + p + ".json", function (a) {
              for (var f = 0; f < a.listItems.length; f++) {
                if (
                  ("laravel" === t("body").attr("data-framework") &&
                    (a.listItems[f].url = l + a.listItems[f].url),
                  !0 === n)
                ) {
                  s = "";
                  for (
                ...
                0 == a.listItems[f].name.toLowerCase().indexOf(e) &&
                  m < 5 &&
                  ((o +=
                    '<li class="auto-suggestion ' +
                    (0 === m ? "current_item" : "") +
                    ...
                    a.listItems[f].url +
                    '><div class="d-flex justify-content-start align-items-center">' +
                    feather.icons[a.listItems[f].icon].toSvg({
                      class: "me-75 ",
                    }) +
                    "<span>" +
                    a.listItems[f].name +
              ...
              for (f = 0; f < a.listItems.length; f++) {
                if (!0 === n) {
                  for (
                    s = "", p = t("ul.nav.navbar-nav.bookmark-icons li"), v = 0;
                    v < p.length;
                    v++
                  )
                    s =
                ...
                0 != a.listItems[f].name.toLowerCase().indexOf(e) &&
                  a.listItems[f].name.toLowerCase().indexOf(e) > -1 &&
                  m < 5 &&
                  ((r +=
                    '<li class="auto-suggestion ' +
                    (0 === m ? "current_item" : "") +
              ...
              (u = t(".main-search-list-defaultlist").html()),
                "" == o &&
                  "" == r &&
                  (r = t(".main-search-list-defaultlist-other-list").html()),
                (i = d.concat(o, r, u)),
            ...
            for (
              var f = t("ul.nav.navbar-nav.bookmark-icons li"), v = "", g = 0;
              g < f.length;
              g++
            ) {
              var C = "";
    ...
    var z = s.attr("data-layout") ? s.attr("data-layout") : "light-layout";
    t(".nav-link-style").on("click", function () {
      var a = T(),
        e = "",
        n = localStorage.getItem(z + "-prev-skin", a);
      (e =
        "dark-layout" !== a
          ? "dark-layout"
          : a === n
          ? "light-layout"
          : n || "light-layout"),
        localStorage.setItem(z + "-prev-skin", a),
        localStorage.setItem(z + "-current-skin", e),
        t.ajax({
          headers: {
          ...
          s.removeClass("semi-dark-layout dark-layout bordered-layout"),
            "dark-layout" === r
              ? (s.addClass("dark-layout"),
                ...
                l.removeClass("navbar-light").addClass("navbar-dark"),
                e
                  .find(".ficon")
      ...
      localStorage.getItem(z + "-current-skin");
